...
import adapter.ElevatorAdapter;
...
//	private int textHeight;
    ...
    public Elevator(Context context, AttributeSet attrs) {
        ...
        normalColor = "#333333";
        final Animation firstAnimation = AnimationUtils.loadAnimation(context, R.anim.elevator_first_rotate);
        final Animation backAnimation = AnimationUtils.loadAnimation(context, R.anim.elevator_back_rotate);
        ...
        LayoutInflater.from(context).inflate(R.layout.elevator_layout, this, true);
        ...
        adapter = new ElevatorAdapter(context, R.layout.elevatortext, itemList);
...
//		upPopView.measure(w, h);
    ...
    public void setList(final List<ElevatorBean> list) {
        int id = 0;
        itemList.clear();
        ...
        for (final ElevatorBean item : itemList) {
