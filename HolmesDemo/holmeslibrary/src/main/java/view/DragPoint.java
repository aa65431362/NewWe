...
public class DragPoint extends TextView {
...
//        initbg();
    ...
    public OnDragListener getOnDragListencer() {
    ...
    public void setBackgroundColor(int backgroundColor) {
        ...
        DragPoint.this.setBackgroundDrawable(createStateListDrawable(
    ...
    private void initbg() {
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            @Override
            public boolean onPreDraw() {  // 返回true则继续进行绘制，返回false则取消绘制
                if (!initBgFlag) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                DragPoint.this.setVisibility(View.INVISIBLE);
                break;
    ...
    class PointView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (out) { // 绘制爆炸效果
                ...
                if (nearby && !broken) { // 未超过最大距离并且未曾拉断过
        ...
        public void cancel() {
            ...
            set.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    DragPoint.this.setVisibility(View.VISIBLE);
                }
            });
            set.start();
        }
