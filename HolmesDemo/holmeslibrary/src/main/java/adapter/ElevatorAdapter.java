...
//	private int textHeight;
    ...
    public ElevatorAdapter(Context context, int resourceId, List<ElevatorBean> itemList) {
    ...
    @Override
    public ElevatorBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ElevatorBean item = getItem(position);
        View view;
        ...
        if (convertView == null) {
            ...
            viewHolder.textView = (TextView) view.findViewById(R.id.elevator_text);
            viewHolder.imageView = (ImageView) view.findViewById(R.id.elevator_icon);
